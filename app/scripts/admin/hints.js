...
(function () {
    ...
    admin.createRoom = function(name){
        ...
        room.ui = {
            ...
            $languageSwitch: $('.hints.' + name + ' .language-switch')
        };
        ...
        room.printHints = function(snapshot){
            ...
            for (var i = 0; i < data.list.length; i++) {
                var item = data.list[i],
                    ...
                    el = $('<li data-level="' + item.level + '" data-id="' + item.id + '" class="hints-list-item ' + active + '"> <h4 class="hints-list-item-title">' + item.name + '</h4>' + content + '</li>');
